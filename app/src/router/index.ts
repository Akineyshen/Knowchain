...
const routes: RouteRecordRaw[] = [
    ...
    { path: '/Withdraw', name: 'withdraw', component: () => import('@/views/Withdraw/Withdraw.vue') },
    // Settings Pages
    { path: '/Settings', name: 'settings', component: () => import('@/views/Settings/Settings.vue') },
    // Lesson Pages
    { path: '/course/:courseId/lesson/:id', name: 'Lesson', component: () => import('@/views/Lesson/Lesson.vue'), props: true },
    // Games Pages
